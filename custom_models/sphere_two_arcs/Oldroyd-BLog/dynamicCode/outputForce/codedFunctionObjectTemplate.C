...
{
    // dynamicCode:
    // SHA1 = e5606579b18c747bc369a94a814581f2a6682861
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void outputForce_e5606579b18c747bc369a94a814581f2a6682861(bool load)
    {
        if (load)
        {
...
bool outputForceFunctionObject::read(const dictionary& dict)
{
    if (false)
    {
        Info<<"read outputForce sha1: e5606579b18c747bc369a94a814581f2a6682861\n";
    }
...
bool outputForceFunctionObject::execute()
{
    if (false)
    {
        Info<<"execute outputForce sha1: e5606579b18c747bc369a94a814581f2a6682861\n";
    }
...
bool outputForceFunctionObject::write()
{
    if (false)
    {
        Info<<"write outputForce sha1: e5606579b18c747bc369a94a814581f2a6682861\n";
    }

//{{{ begin code
    #line 65 "/home/clove/rheoTool/of90/custom_models/sphere_two_arcs/Oldroyd-BLog/system/controlDict/functions/outputForce"
...
bool outputForceFunctionObject::end()
{
    if (false)
    {
        Info<<"end outputForce sha1: e5606579b18c747bc369a94a814581f2a6682861\n";
    }
